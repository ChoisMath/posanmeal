...
- [2026-09-20 main 통합·운영 DB 이전 진행](2026-09-20-main-merge-and-activation.md): 모든 브랜치·검토한 미커밋 안내/영상 포함 main 푸시와 운영 DB 데이터 이전 승인. 날짜 없는 희망조사 120건 보존·2026 귀속 확정, 키오스크 미전송 0건·중지 재확인. 로컬 main 통합·격리 build·unit 584/guide 4/PG 420 통과, 전체 lint 기존 오류는 남음. 새 서비스와 dinner의 동일 DB·기적용 migration을 live 재확인했으며, 최신 백업·보존 처리 보완 진행 중. main 푸시·운영 DB 쓰기·READY는 아직 미실행.
