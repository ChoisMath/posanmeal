...
- [2026-09-20 교사 달력·학생표 표시 조정](2026-09-20-calendar-table-polish.md): 교사 달력 요일 헤더색·최소104px 동일 행높이·좌상단 날짜/근무/시간 배치, 학생표 음영·선·헤더색·세로 간격 조정(44px 라벨 유지). 이전 type/lint/반응형 리뷰·5개 폭 동일높이/넘침 검증 PASS. 사용자 푸시 승인/준비 완료, unit586/type/변경2파일 lint/generate·소스 일치 격리 webpack build42/42 재통과. DB/Railway/config/package 변경 없음. 커밋·푸시 실행 전으로 결과 추후 확인. 실기기·물리 인쇄·운영 검증 미실시.

- [2026-09-20 교사 확인 달력 표시 개선](2026-09-20-teacher-calendar-ui.md): 사용자 승인으로 석식 이력 표시 제거·월 이동/주말 토글 한 줄, 기본 평일 5열/주말 포함 7열과 토파랑·일빨강 날짜선. 학생 달력·주말 기록·미신청 음영 보존, 학생표 가로세로 선 stone-400. unit586·type·변경 lint·diff·5개 폭 달력·432개월 계산 검증/독립 리뷰 및 전체 UI·QR 인쇄 PDF 회귀 통과. 후속 교사 달력 좌우 스와이프 월 이동 승인 구현: CDP touch 실패→PASS·5개 폭 날짜 회귀·unit586/type/lint/diff 통과, 학생 미적용·주말 상태 유지. 스와이프 preview 종료 exit0. 후속 커밋·푸시 승인/준비 완료, unit586/type/변경3파일 lint/generate 재통과·소스 일치 격리 webpack build42/42 통과. 기록은 실행 직전. 커밋·푸시 결과/원격 SHA·배포 완료 미확인, 실계정·실기기·물리 인쇄 미실행.

- [2026-09-20 교사·학생 페이지 표시 개선](2026-09-20-role-page-ui.md): 사용자 승인 후 책갈피 탭·내부 스크롤, 교사 학생표 전체 폭·상단 도구 한 줄·학년도 안내 하단 이동. 음영·학생 선택·QR 출력 유지. unit586·type·변경 lint·generate 재검증 및 소스 일치 격리 production webpack build42/42 통과(운영 env 없이 dummy DB). diff·5개 폭 예시 API/QR 인쇄 PDF·반응형 검토 통과. 커밋·푸시 승인/준비 완료, 기록은 실행 직전으로 결과·원격 SHA 추후 확인. 실제 로그인·실기기·물리 인쇄·전체 lint·deploy 미실행.

- [2026-09-20 교사·담임 안내 제작](2026-09-20-teacher-guide.md): 공개 `/help/teacher` 4목차·9단계, 역할별 도움말·TeacherGuide 14장면48문장 완료. 최종 MP4 325.653333초·26,782,125bytes와 VTT·WebP14장 배치. unit586·제작30·타입·변경 lint·원음48/48·전사 CHECK0·최종 파형48/48·전체 디코딩 통과. 3개 폭·영상재생/170초탐색·목차·HelpButton SSR 확인. 사람 직접 청취·실기기·교사 실로그인·운영배포·커밋푸시 미실행.

- [2026-09-20 관리자 화면 공간·도구 배치 개선](2026-09-20-admin-compact-ui.md): 책갈피 탭·교사/학년 필터·Excel 모달·설정 이동을 main `ccfe6fdd`로 푸시 완료(unit586·type·변경 lint·generate·격리build41/41). 운영 학년도 숫자만, 글꼴 변경 없음. 후속 당일현황 도구 한 줄·표 남은 높이 채우기·설정 밀도 개선은 미커밋/미푸시; unit586·type·lint·5개 폭 예시 API 검증 통과, 후속 격리 build41/41 통과, 커밋·푸시 요청 승인(기록은 실행 직전), 실기기·운영 사이트 검증 미실행. 전체 lint·실제 Excel·DB 변경 미실행, 배포 결과 별도 확인.
