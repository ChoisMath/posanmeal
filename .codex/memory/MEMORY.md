...
- [2026-09-20 학년도 명부 배포 준비](2026-09-20-academic-deploy-preflight.md): push/deploy 승인, 준비 브랜치 3개 푸시. DB·사진 백업 및 분리 복원, 11개 테이블 원본 비교·사진 8개 해시 일치, 복원본 추가 migration 검증. 날짜 없는 과거 공고 1개·신청 120건의 의미 확인 대기이며 기존 사진 파일 결측 6개도 기록했다. 운영 main/DB/배포 미변경.
