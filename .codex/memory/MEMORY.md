...
- [2026-09-19 학년도별 학생·교사 명부 요구사항](2026-09-19-academic-year-roster-requirements.md): User.id 유지·2026학년도부터 누적, 최종 학급 보존·명부 삭제·졸업/전출 로그인 차단, 통합 Excel·초안·관리자 전환 확정. [상세설계 spec](../../docs/superpowers/specs/2026-09-19-academic-year-roster-design.md) 전체와 §13 세부정책 사용자 승인 완료. [15 Tasks 구현계획](../../docs/superpowers/plans/2026-09-19-academic-year-roster.md) 작성·자체 검토 완료, 사용자 계획 검토와 실행방식(Subagent-driven 권장 / Native) 선택 대기. 문서 경로·수정 대상 존재·Task 수·미정 문구·TypeScript 예시 문법·공백 검사만 수행했다. 앱 구현·앱 타입/테스트/build·DB/복원/마이그레이션·배포는 미실행. 상세설계 로컬 커밋 `04edcc0`, 이번 계획은 아직 미커밋. 같은 날 계획 검토 뒤 개정(잠금 범위 축소·일괄 쓰기, 로컬 명부 자정 차단 폐기, 이용 중단 시 얼굴 등록 삭제, Excel 행 단위 충돌, 전환 경고, 명부 사본 보존기간, Task 4A·Release A/B 2단계 배포)을 사용자 승인 후 spec·계획에 반영, 미커밋.
