...
- [2026-09-19 학년도별 학생·교사 명부 요구사항](2026-09-19-academic-year-roster-requirements.md): User.id 유지·2026학년도부터 누적, 학년도 최종 학급 보존, 명부 삭제 허용·졸업/전출 로그인 차단, 학생/교사 통합 Excel과 초안·관리자 명시 전환 확정. [상세설계 spec](../../docs/superpowers/specs/2026-09-19-academic-year-roster-design.md) 작성 및 migration guardian 개념 검토 보완 완료. 사용자 문서 검토 대기이며 §13은 미합의 새 제안이다. 다음 단계는 문서 승인 → 구현계획. 읽기 전용 코드 조사·문서 경로/placeholder·공백 검사만 수행했고 DB 접속·앱 테스트·마이그레이션·배포는 미실행.
