...
> 2026-09-20 학년도 명부 최신 실행 상태는 [배포 준비 인계](2026-09-20-academic-deploy-preflight.md), 구현 결과는 [재개 완료 인계](2026-09-20-academic-year-roster-handoff.md)를 먼저 읽는다. 준비 브랜치 푸시·백업·분리 복원 검증 후 과거 공고의 처리 기준 확인을 기다리고 있으며 운영 main은 유지했다. 아래 9월 19일 시작·배포 준비 상태는 당시 이력이다.
